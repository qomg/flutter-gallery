...
class MenuDemo extends StatefulWidget {
  const MenuDemo({Key? key, required this.type}) : super(key: key);
...
class _ContextMenuDemo extends StatelessWidget {
  const _ContextMenuDemo({Key? key, required this.showInSnackBar}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return ListTile(
      title: Text(GalleryLocalizations.of(context)!.demoMenuAnItemWithAContextMenuButton),
...
class _SectionedMenuDemo extends StatelessWidget {
  const _SectionedMenuDemo({Key? key, required this.showInSnackBar}) : super(key: key);
...
class _SimpleMenuDemo extends StatefulWidget {
  const _SimpleMenuDemo({Key? key, required this.showInSnackBar}) : super(key: key);
